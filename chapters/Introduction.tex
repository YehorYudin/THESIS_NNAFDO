...
This method uses the idea of ``artificial density''\cite{to_simp} where for every hexahedral element of discretized model some density variable $\rho$ is assigned.
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/cnn_dem_padding1.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/cnn_dem_opration2.pdf}
...
One of the further notifications is a \textit{Exponential Rectifier}.
...
\begin{figure}[]
	\centering
	\includegraphics[width=0.7\linewidth]{images/activfunc_3.pdf}
