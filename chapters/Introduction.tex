...
In this chapter, we describe principles and the application scope of Topology Optimization algorithms and explain the performance challenges of this method.
...
Finally, alongside with the explanation of Topology Optimization method, we give a description of Convolutional Neural Networks, their principles, and all their components.
...
As one of the possible approaches to finding suitable initial guess for TO, we propose using predictive model based on Artificial Neural Network (ANN).
...
In this work, we design such ANN system and train the model on a dataset which consists of the known cases of Topology Optimization problems. 
