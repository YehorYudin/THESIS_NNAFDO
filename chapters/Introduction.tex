...
\bigskip
\todo{change the rational to the idea of decrease the domain}
...
\begin{figure}[]
	\includegraphics[width=\linewidth]{images/TO_flowchart.pdf}
...
\todo{add figured demostrating loss function surface, GD process and variations}
