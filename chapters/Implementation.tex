...
The CNN architecture we chosen to create the model describing the dependency between boundary conditions and the resulting material layout relates to tha class of \textiti{encoder-decoder} networks.
