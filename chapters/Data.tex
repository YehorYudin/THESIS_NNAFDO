...
\begin{figure}
	\begin{multicols}{3}
	\includegraphics[width=0.7\linewidth]{images/TOcase_init.pdf}
	\includegraphics[width=0.7\linewidth]{images/TOcase_23bc.pdf}
	\includegraphics[width=0.7\linewidth]{images/TOcase_2pbcsvg.pdf}
	\end{multicols}
