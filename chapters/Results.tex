...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{images/tempplot.png}
...
\begin{figure}[H]
	\begin{subfigure}[b]{0.4\linewidth}
		\centering
		\includegraphics[width=1.5\linewidth]{images/hitmap_e16_15k_avg.pdf}
		\caption{Number of iterations $15,000$}
		\label{fig:heatmaps_overfit_1}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\linewidth}
		\centering
		\includegraphics[width=1.5\linewidth]{images/hitmap_dpcr13-40k_avg.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{images/tempplot_SIZE.png}
