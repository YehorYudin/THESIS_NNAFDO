...
The architecture for the 3D case is very similar to the 2D one, with every convolution replaced with a corresponding \textit{3D convolution}, where channels and kernels are cubes and summation happens across $3$ dimensions.
